...
Rails.application.configure do
  ...
  # Raise delivery errors so we can see SMTP failures.
  ...
  # Log to STDOUT when running in Docker (so `docker logs` works)
  if ENV["RAILS_LOG_TO_STDOUT"].present? || File.exist?("/.dockerenv")
