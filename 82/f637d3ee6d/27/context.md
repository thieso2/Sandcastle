...
explain Ruby 4.0 incompatibilities - arenÄt we eunnint ruby 4.0 everywhere and from the start? Make sure we use the same ruby version everywhere and that all tests are green!
