...
do in need to build new images?

### Prompt 3

i installed via cual installer.sh - is all included in the installer?

### Prompt 4

lead a not in CLAUDE.md about this!
...
thies@sandman:~$ sudo /sandcastle/docker-runtime/bin/docker compose logs -f
no configuration file provided: not found

### Prompt 7

add /sandcastle/docker-runtime/bin/docker-logs taht does 
...
can i use installer.sh to just update and pull new images? (mode update?)
